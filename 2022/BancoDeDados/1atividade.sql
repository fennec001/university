...
-- inserindo registro INSERT INTO categoria VALUES (1, 'categoria 1');

--adicionando nova coluna

ALTER TABLE categoria
ADD COLUMN ds_observacao VARCHAR(30);

-- alterando tipo de dado da coluna
ALTER TABLE categoria
MODIFY ds_observacao CHAR(10);

-- adicionando uma unique key na coluna nm_categoria
ALTER TABLE categoria
ADD UNIQUE KEY (nm_categoria); 
...
alter table filme
add foreign key (cd_censura) 
	references censura(cd_censura);
alter table filme
add foreign key (cd_genero)
